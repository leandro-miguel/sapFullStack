		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#project1fullstack-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project1fullstack-display": {
								"semanticObject": "project1fullstack",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1fullstack",
									"url": sap.ui.require.toUrl("project1fullstack")
								}
							}
						}
					}
